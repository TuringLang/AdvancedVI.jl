...
@testset "KLMinSqrtNaturalGradDescent" begin
    begin
        ...
        @testset "reported ELBO" begin
            seed = 0x2c88965e8a66013a
            n_samples = 3
            alg = KLMinSqrtNaturalGradDescent(; n_samples, stepsize=1e-3)
    ...
    @testset "error low capability" begin
        ...
        alg = KLMinSqrtNaturalGradDescent(; n_samples=10, stepsize=1.0)
